...
## DAB ENERGY TRUST — Doubs · Adamstown · Buckeystown
...
I am fighting for my community anyway.
...
- **A. Energy Trust** — operators pay per energized megawatt; 100 percent of the dividend goes to eligible DAB meters until the proposed ordinance floor is met.
- **C. Infrastructure stake** — county or co-op holds title or a recorded lease on campus-serving water, sewer, roads, and right-of-way pads the public pays for; rent to the Trust.
- **D. Residual / equity** — covenant on land rezoned into LI or GI inside the overlay after January 20, 2026; seek 2027 state authority for a non-voting economic interest in CDI projects over 50 MW, dedicated to this Trust.
...
HR&A Advisors (October 30, 2025), Tables 3 and 14, report Quantum-related recordation tax through 2025 year-to-date as follows: **$1.40 million** on the Eastalco purchase, **$6.67 million** on tenant sales, and **$44.9 million** on debt service — **$52.97 million** in total, or about **$53 million**. County Executive Jessica Fitzwater testified that the project had already generated “over $50 million in recordation tax revenue as of November 2025” (SB 427 testimony, February 18, 2026). The same HR&A tables report $2.24 million in real property tax on land through 2025 YTD. This filing does not claim a June 30, 2026 county ledger total.
...
## 4. Campus scale used for the formula

Published program for Quantum Frederick / the Catellus lead-developer campus: planned **2.4 gigawatts**, about **17.4 million square feet**, on about **2,100 acres**. That campus figure is not the same number as the CDI overlay acreage (~**2,614.9 acres**).

The campus was not at stabilized operations as of mid-2026; construction is underway. Aligned Data Centers: about **264 MW** planned across the campus; building IAD-04 (about **72 MW**) topped out in January 2026. Rowan Digital / AWS Bauxite construction is underway.

**Countywide annual forecasts at full buildout / stabilization** (not meter credits in Doubs, Adamstown, or Buckeystown):

- Sage Policy Group (October 2023): about **$40.9 million** (about **$41 million**) annual county fiscal revenue — about $37.7 million real property plus about $3.2 million income tax.
- County Executive SB 427 testimony (February 18, 2026): “approximately **$68.8 million** annually in real property taxes” for the already-approved project.
- HR&A Table 16 (October 30, 2025): about **$215 million** annual fiscal revenue ($195 million real property on improvements + $13.2 million real property on land + $4.74 million personal income tax + $2.04 million stormwater fee; table total $214.98 million).

**Those are Winchester Hall numbers, not Manor Woods numbers.**
...
- § 1-19-10.1100 CDI overlay; LI/GI only; overlay less than 1% of county land.
- § 1-19-8.402 / 8.403 facilities and substations; 500-foot setback if abutting residential.
- Chapter 1-25 DRRA must list enhanced public benefits and their value — put the dividend and infrastructure lease in that paragraph.
...
- Maryland Supreme Court opinion (July 24, 2026), In re Frederick County Data Center Referendum Committee, No. 67, Sept. Term 2025
- Frederick County CDI Overlay (Ord. 26-01-001)
- County Executive rejects Catellus community-benefits agreement (Sept. 14, 2026)
- Catellus $110M community-benefit announcement (Sept. 1, 2026)
...
# Grandfather Clause — Keep This Version of Frederick
...
**January 20, 2026** — the effective date of Ordinance 26-01-001 (CDI overlay).
...
- **No new buildings qualify.**
- New construction, subdivisions, apartments, and commercial pads **after** the January 20, 2026 cutoff are **not grandfathered**.
- This clause is **not** a license to expand, intensify, or rebuild larger after the cutoff and still claim grandfathered Trust preference.
- It is an incentive to **keep what we have**, not a growth subsidy.

This section is proposed ordinance language for Council to enact with the DAB ENERGY TRUST. It is not current law until adopted.

---

# Public Declaration — Host-Community Rebate

## Declaration

**Host communities Doubs, Adamstown, and Buckeystown are why this revenue exists.** The campus sits on our doorstep — on the rural-industrial and grid edge we live next to. The rest of the county collects the benefit of a burden we live next to.

Sourced figures show about **$53 million** already collected on Quantum-related recordation transactions ($1.40M + $6.67M + $44.9M = $52.97M per HR&A). That money does not appear as a power-bill credit on DAB meters.

Countywide forecasts of about **$41 million**, **$68.8 million**, and **$215 million** annual fiscal revenue at buildout are **countywide buildout forecasts** — not money in DAB pockets. Those are Winchester Hall numbers, not Manor Woods numbers.

The Trust dividend is a **rebate due host communities** for site, grid edge, roads, rural buffer, and lived impact.

**Nobody else generated this. Winchester Hall numbers came off Manor Woods ground.**

## How to hear this argument

This is a rebate and credit argument for host communities. It does not allege criminal theft or illegal conduct. Recordation and property-tax dollars follow county and state formula; the ask is that host communities receive an operator-funded meter credit and Trust structure because they carry the lived burden of the campus and overlay.
...
| **Schedule A** | Proposed floor **$250** per meter per year; **$1/MWh** of prior-twelve-month campus IT load between floor and cap; proposed cap **$1,000**; not enacted until Council adopts. |

When Council enacts the Trust, the January 20, 2026 grandfather cutoff and host-community rebate framing in this packet should be incorporated into Schedule A and Article III.

## Resident handout / script
...
Why we’re doing this — my wife pulls out of our driveway onto MD 85 with our six-month-old and has to time it like a gap in freeway traffic. That’s not a statistic. That’s our morning.
...
Doubs, Adamstown, Buckeystown first. That is the ask.
...
A note to our neighbors in Doubs, Adamstown, and Buckeystown
